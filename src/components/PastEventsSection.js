...
const PastEventsSection = () => {
    ...
    return (
        <section id="past-events" className="py-20 bg-gray-900/50">
            <div className="container mx-auto px-6">
                <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">Event Rewind</h2>
                ...
                <div className="flex overflow-x-auto space-x-8 pb-8 horizontal-scroll-container">
                    {pastEvents.map(event => (
                        <div key={event.title} className="flex-shrink-0 w-80 glass-card rounded-xl overflow-hidden transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/20 hover:-translate-y-2">
                            <img src={`https://placehold.co/600x400/1f2937/ffffff?text=${event.img}`} alt={event.title} className="w-full h-40 object-cover"/>
                            <div className="p-6">
                    ...
                    <div className="flex-shrink-0 w-80 glass-card rounded-xl flex flex-col items-center justify-center text-center p-6 bg-blue-900/20 border-blue-500/50">
                        <h3 className="text-2xl font-bold">Be Part of the Next Big Thing</h3>
                        <p className="text-gray-300 mt-4 mb-6">Don't miss out on our upcoming events. Join the largest technical community on campus.</p>
                        <a href="#" className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg transition-colors duration-300 flex items-center group">
